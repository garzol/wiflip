...
#                                      "Main style's name"],
                ...
                u"#Handicap #4":[defaultExtraBall, 
                                         ...
                                         "4th handicap (High score to date x10 (Player #4)",
                                         HandiTStr,
                                         Hex("00000", 0x73, "bcd", -1)],
                u"#Handicap #3":[defaultExtraBall, 
                                         Hex, 
                                         MyOptionsUtils.myValidateHex, 0, 99999, 
                                         "3rd handicap (High score to date x10 (Player #3)",
                                         HandiTStr,
                                         Hex("00000", 0x7B, "bcd", -1)],
                u"#Handicap #2":[defaultExtraBall, 
                                         Hex, 
                                         MyOptionsUtils.myValidateHex, 0, 99999, 
                                         "2nd handicap (High score to date x10 (Player #2)",
                                         HandiTStr,
                                         Hex("00000", 0x6B, "bcd", -1)],
                u"#Handicap #1":[defaultExtraBall, 
                                         Hex, 
                                         MyOptionsUtils.myValidateHex, 0, 99999, 
                                         "1st handicap (High score to date x10 (Player #1)",
                                         HandiTStr,
